...
function animate(timestamp) {
  if (gameLogic()) {
    ...
    if (gameState.score > 200) {
      ...
      superlative = "You did well!";
    } else {
      superlative = "You did alright.";
    }
    var t = new PIXI.Text("Game over! Your score is " + gameState.score + ". " + superlative, {font: "15px", fill: "white"})
    t.position.x = 50;
...
function init() {
  // show instructions
  startText  = new PIXI.Text("Drag the fish to play! Eat the smaller blocks to spawn fishy friends!", {font: "15px", fill: "white"})
